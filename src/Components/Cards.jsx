  ...
  return (
    <div className="border rounded ">
      {value.show || value.done ? (
        <div className="h-full w-full bg-white rounded overflow-hidden flex justify-center p-3 font-bold text-5xl items-center">
          <img src={value.image} className="w-full h-full rounded" alt="" />
        </div>
      ) : (
        <div
